        ...
        public bool CrearVehiculo(EVehiculo vehiculo, EPropietario propietario)
        {
            try
            {
                ...
                if (resultado )
                {
                    ...
                    EnvioCorreos.EnviarRegistroVehiculo(correo, nombres, apellidos, vehiculo.placa, vehiculo.modelo, vehiculo.color, vehiculo.año, vehiculo.cilindraje, vehiculo.valor);
                }
